...
export default function GetInTouchPage() {
  ...
  if (state.succeeded) {
    return (
      <div className="h-[30vh] w-1/2 mx-auto my-20">
        <p className="text-3xl lg:text-5xl text-green-800">
  ...
  return (
    <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      >
        <div
          className="relative left-1/2 -z-10 aspect-[1155/678] w-[36.125rem] max-w-none -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#e9bbce] to-[#ada8ef] opacity-30 sm:left-[calc(50%-40rem)] sm:w-[72.1875rem]"
          style={{
            clipPath:
